...
if (var.find("reco_beam_startX-beam_inst_X")!=std::string::npos){
h1d_reco_stack_endZ->GetYaxis()->SetTitle("Number of Events");
h1d_reco_stack_endZ->GetXaxis()->SetTitle("#DeltaX_{TPC-beamline} [cm]");
h1d_reco_stack_endZ->GetYaxis()->CenterTitle();
h1d_reco_stack_endZ->GetXaxis()->CenterTitle();
}
if (var.find("reco_beam_startY-beam_inst_Y")!=std::string::npos){
h1d_reco_stack_endZ->GetYaxis()->SetTitle("Number of Events");
h1d_reco_stack_endZ->GetXaxis()->SetTitle("#DeltaY_{TPC-beamline} [cm]");
h1d_reco_stack_endZ->GetYaxis()->CenterTitle();
h1d_reco_stack_endZ->GetXaxis()->CenterTitle();
}
if (var.find("reco_beam_startZ-beam_inst_Z")!=std::string::npos){
...
if (var.find("Sum$(reco_daughter_allTrack_len>0)")!=std::string::npos){
h1d_reco_stack_endZ->GetYaxis()->SetTitle("Number of Events");
h1d_reco_stack_endZ->GetXaxis()->SetTitle("Number of Reco. Secondaries");
h1d_reco_stack_endZ->GetYaxis()->CenterTitle();
h1d_reco_stack_endZ->GetXaxis()->CenterTitle();
...
if(var.find("Sum$(reco_daughter_allTrack_len>0)")!=std::string::npos) var="reco_daughter_allTrack_mult";


c1.Print(Form("validationPlots/kaonEval%s_%d_%d_wDataStandard%dGeV.png",var.c_str(),selection_ID,data,mom));
c1.Print(Form("validationPlots/kaonEval%s_%d_%d_wDataStandard%dGeV.pdf",var.c_str(),selection_ID,data,mom));
