...
void anaUnfoldStandardGen_RespShifts::Loop(int nUniverses, std::string weightDecision)
{
...
TFile *fWrite=new TFile(Form("kaonRespShiftOutputStandardGen_%s_%d.root",weightDecision.c_str(),nUniverses),"recreate");
...
std::string fileName="kaonUnfoldStandardGenRecoPlots.root";
