...
#ifndef anaUnfoldTrainingStandard_ChangeIndep_h
#define anaUnfoldTrainingStandard_ChangeIndep_h
...
class anaUnfoldTrainingStandard_ChangeIndep {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldTrainingStandard_ChangeIndep(TTree *tree=0);
   virtual ~anaUnfoldTrainingStandard_ChangeIndep();
...
#ifdef anaUnfoldTrainingStandard_ChangeIndep_cxx
anaUnfoldTrainingStandard_ChangeIndep::anaUnfoldTrainingStandard_ChangeIndep(TTree *tree) : fChain(0) 
{
...
anaUnfoldTrainingStandard_ChangeIndep::~anaUnfoldTrainingStandard_ChangeIndep()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldTrainingStandard_ChangeIndep::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldTrainingStandard_ChangeIndep::LoadTree(Long64_t entry)
{
...
void anaUnfoldTrainingStandard_ChangeIndep::Init(TTree *tree)
{
...
Bool_t anaUnfoldTrainingStandard_ChangeIndep::Notify()
{
...
void anaUnfoldTrainingStandard_ChangeIndep::Show(Long64_t entry)
{
...
Int_t anaUnfoldTrainingStandard_ChangeIndep::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldTrainingStandard_ChangeIndep_cxx
