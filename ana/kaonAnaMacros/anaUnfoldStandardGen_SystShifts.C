...
for(int universe=0; universe<nUniverses; universe++){
   ...
   nobeam_var=gRandom->Gaus(0.976,0.06);
...
else brkTrk_weight=(1-brkTrk_var*0.03035)/(1-0.03035);
...
if (reco_beam_calo_wire_z->at(index)<51.8865+startShift || reco_beam_calo_wire_z->at(index)>220.00+endShift) continue;
