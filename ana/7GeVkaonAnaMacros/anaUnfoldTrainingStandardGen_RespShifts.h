...
#ifndef anaUnfoldTrainingStandardGen_RespShifts_h
#define anaUnfoldTrainingStandardGen_RespShifts_h
...
class anaUnfoldTrainingStandardGen_RespShifts {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldTrainingStandardGen_RespShifts(TTree *tree=0);
   virtual ~anaUnfoldTrainingStandardGen_RespShifts();
...
#ifdef anaUnfoldTrainingStandardGen_RespShifts_cxx
anaUnfoldTrainingStandardGen_RespShifts::anaUnfoldTrainingStandardGen_RespShifts(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("7GeVkaonTreeSel.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("7GeVkaonTreeSel.root");
      }
...
anaUnfoldTrainingStandardGen_RespShifts::~anaUnfoldTrainingStandardGen_RespShifts()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldTrainingStandardGen_RespShifts::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldTrainingStandardGen_RespShifts::LoadTree(Long64_t entry)
{
...
void anaUnfoldTrainingStandardGen_RespShifts::Init(TTree *tree)
{
...
Bool_t anaUnfoldTrainingStandardGen_RespShifts::Notify()
{
...
void anaUnfoldTrainingStandardGen_RespShifts::Show(Long64_t entry)
{
...
Int_t anaUnfoldTrainingStandardGen_RespShifts::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldTrainingStandardGen_RespShifts_cxx
