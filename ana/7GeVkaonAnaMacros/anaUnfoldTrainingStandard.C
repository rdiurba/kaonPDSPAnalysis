...
//double edges[5]={4700,5000,5200,5400,5620,6020};
//double edges[6]={3000,4970,5200,5400,5630,7000};
//Data binning
totBins=2;
//double edges[5]={4000,5000,5240,5440,6650/*5000,5240,5440,5700,6650*/};
...
TFile *fout = new TFile(Form("7GeVkaonUnfoldStandardGenTrainingRecoPlots.root"),"RECREATE");
...
t->SetBranchAddress("reco_beam_calo_wire",&reco_beam_calo_wire_data);
   Long64_t nentries_start=t->GetEntries()*0.66667+1;
