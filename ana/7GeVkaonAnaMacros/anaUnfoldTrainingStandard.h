...
#ifndef anaUnfoldTrainingStandard_h
#define anaUnfoldTrainingStandard_h
...
class anaUnfoldTrainingStandard {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldTrainingStandard(TTree *tree=0);
   virtual ~anaUnfoldTrainingStandard();
...
#ifdef anaUnfoldTrainingStandard_cxx
anaUnfoldTrainingStandard::anaUnfoldTrainingStandard(TTree *tree) : fChain(0) 
{
...
anaUnfoldTrainingStandard::~anaUnfoldTrainingStandard()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldTrainingStandard::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldTrainingStandard::LoadTree(Long64_t entry)
{
...
void anaUnfoldTrainingStandard::Init(TTree *tree)
{
...
Bool_t anaUnfoldTrainingStandard::Notify()
{
...
void anaUnfoldTrainingStandard::Show(Long64_t entry)
{
...
Int_t anaUnfoldTrainingStandard::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldTrainingStandard_cxx
