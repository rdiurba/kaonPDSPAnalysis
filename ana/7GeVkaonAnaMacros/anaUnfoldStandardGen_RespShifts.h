...
#ifndef anaUnfoldStandardGen_RespShifts_h
#define anaUnfoldStandardGen_RespShifts_h
...
class anaUnfoldStandardGen_RespShifts {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldStandardGen_RespShifts(TTree *tree=0);
   virtual ~anaUnfoldStandardGen_RespShifts();
...
#ifdef anaUnfoldStandardGen_RespShifts_cxx
anaUnfoldStandardGen_RespShifts::anaUnfoldStandardGen_RespShifts(TTree *tree) : fChain(0) 
{
...
anaUnfoldStandardGen_RespShifts::~anaUnfoldStandardGen_RespShifts()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldStandardGen_RespShifts::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldStandardGen_RespShifts::LoadTree(Long64_t entry)
{
...
void anaUnfoldStandardGen_RespShifts::Init(TTree *tree)
{
...
Bool_t anaUnfoldStandardGen_RespShifts::Notify()
{
...
void anaUnfoldStandardGen_RespShifts::Show(Long64_t entry)
{
...
Int_t anaUnfoldStandardGen_RespShifts::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldStandardGen_RespShifts_cxx
