...
#ifndef anaUnfoldStandardGen_SystShifts_h
#define anaUnfoldStandardGen_SystShifts_h
...
class anaUnfoldStandardGen_SystShifts {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldStandardGen_SystShifts(TTree *tree=0);
   virtual ~anaUnfoldStandardGen_SystShifts();
...
#ifdef anaUnfoldStandardGen_SystShifts_cxx
anaUnfoldStandardGen_SystShifts::anaUnfoldStandardGen_SystShifts(TTree *tree) : fChain(0) 
{
...
anaUnfoldStandardGen_SystShifts::~anaUnfoldStandardGen_SystShifts()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldStandardGen_SystShifts::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldStandardGen_SystShifts::LoadTree(Long64_t entry)
{
...
void anaUnfoldStandardGen_SystShifts::Init(TTree *tree)
{
...
Bool_t anaUnfoldStandardGen_SystShifts::Notify()
{
...
void anaUnfoldStandardGen_SystShifts::Show(Long64_t entry)
{
...
Int_t anaUnfoldStandardGen_SystShifts::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldStandardGen_SystShifts_cxx
