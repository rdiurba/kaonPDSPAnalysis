...
#ifndef anaUnfoldFakeDataStandardGenNoSCE_h
#define anaUnfoldFakeDataStandardGenNoSCE_h
...
class anaUnfoldFakeDataStandardGenNoSCE {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldFakeDataStandardGenNoSCE(TTree *tree=0);
   virtual ~anaUnfoldFakeDataStandardGenNoSCE();
...
#ifdef anaUnfoldFakeDataStandardGenNoSCE_cxx
anaUnfoldFakeDataStandardGenNoSCE::anaUnfoldFakeDataStandardGenNoSCE(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("kaonTreeSel.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("kaonTreeSel.root");
      }
...
anaUnfoldFakeDataStandardGenNoSCE::~anaUnfoldFakeDataStandardGenNoSCE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldFakeDataStandardGenNoSCE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldFakeDataStandardGenNoSCE::LoadTree(Long64_t entry)
{
...
void anaUnfoldFakeDataStandardGenNoSCE::Init(TTree *tree)
{
...
Bool_t anaUnfoldFakeDataStandardGenNoSCE::Notify()
{
...
void anaUnfoldFakeDataStandardGenNoSCE::Show(Long64_t entry)
{
...
Int_t anaUnfoldFakeDataStandardGenNoSCE::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldFakeDataStandardGenNoSCE_cxx
