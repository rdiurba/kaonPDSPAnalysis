...
#ifndef anaUnfoldFakeDataSimpleScale_h
#define anaUnfoldFakeDataSimpleScale_h
...
class anaUnfoldFakeDataSimpleScale {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldFakeDataSimpleScale(TTree *tree=0);
   virtual ~anaUnfoldFakeDataSimpleScale();
...
#ifdef anaUnfoldFakeDataSimpleScale_cxx
anaUnfoldFakeDataSimpleScale::anaUnfoldFakeDataSimpleScale(TTree *tree) : fChain(0) 
{
...
anaUnfoldFakeDataSimpleScale::~anaUnfoldFakeDataSimpleScale()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldFakeDataSimpleScale::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldFakeDataSimpleScale::LoadTree(Long64_t entry)
{
...
void anaUnfoldFakeDataSimpleScale::Init(TTree *tree)
{
...
Bool_t anaUnfoldFakeDataSimpleScale::Notify()
{
...
void anaUnfoldFakeDataSimpleScale::Show(Long64_t entry)
{
...
Int_t anaUnfoldFakeDataSimpleScale::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldFakeDataSimpleScale_cxx
