...
#ifndef anaUnfoldFakeDataStepScale_h
#define anaUnfoldFakeDataStepScale_h
...
class anaUnfoldFakeDataStepScale {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldFakeDataStepScale(TTree *tree=0);
   virtual ~anaUnfoldFakeDataStepScale();
...
#ifdef anaUnfoldFakeDataStepScale_cxx
anaUnfoldFakeDataStepScale::anaUnfoldFakeDataStepScale(TTree *tree) : fChain(0) 
{
...
anaUnfoldFakeDataStepScale::~anaUnfoldFakeDataStepScale()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldFakeDataStepScale::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldFakeDataStepScale::LoadTree(Long64_t entry)
{
...
void anaUnfoldFakeDataStepScale::Init(TTree *tree)
{
...
Bool_t anaUnfoldFakeDataStepScale::Notify()
{
...
void anaUnfoldFakeDataStepScale::Show(Long64_t entry)
{
...
Int_t anaUnfoldFakeDataStepScale::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldFakeDataStepScale_cxx
