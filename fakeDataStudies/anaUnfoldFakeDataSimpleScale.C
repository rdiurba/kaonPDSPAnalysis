#define anaUnfoldFakeDataSimpleScale_cxx
#include "anaUnfoldFakeDataSimpleScale.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void anaUnfoldFakeDataSimpleScale::Loop(double coeff)
{
//   In a ROOT session, you can do:
//      root> .L anaUnfoldFakeDataSimpleScale.C
//      root> anaUnfoldFakeDataSimpleScale t
...
TFile *fout = new TFile(Form("kaonUnfoldStandardGenSampleScale_%1.1f.root",g4rw_index),"RECREATE");
