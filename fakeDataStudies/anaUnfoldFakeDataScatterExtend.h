...
#ifndef anaUnfoldFakeDataScatterExtend_h
#define anaUnfoldFakeDataScatterExtend_h
...
class anaUnfoldFakeDataScatterExtend {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldFakeDataScatterExtend(TTree *tree=0);
   virtual ~anaUnfoldFakeDataScatterExtend();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(double coeff);
...
#ifdef anaUnfoldFakeDataScatterExtend_cxx
anaUnfoldFakeDataScatterExtend::anaUnfoldFakeDataScatterExtend(TTree *tree) : fChain(0) 
{
...
anaUnfoldFakeDataScatterExtend::~anaUnfoldFakeDataScatterExtend()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldFakeDataScatterExtend::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldFakeDataScatterExtend::LoadTree(Long64_t entry)
{
...
void anaUnfoldFakeDataScatterExtend::Init(TTree *tree)
{
...
Bool_t anaUnfoldFakeDataScatterExtend::Notify()
{
...
void anaUnfoldFakeDataScatterExtend::Show(Long64_t entry)
{
...
Int_t anaUnfoldFakeDataScatterExtend::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldFakeDataScatterExtend_cxx
