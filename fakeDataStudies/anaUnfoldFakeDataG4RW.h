...
#ifndef anaUnfoldFakeDataG4RW_h
#define anaUnfoldFakeDataG4RW_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldFakeDataG4RW(TTree *tree=0);
   virtual ~anaUnfoldFakeDataG4RW();
...
#ifdef anaUnfoldFakeDataG4RW_cxx
anaUnfoldFakeDataG4RW::anaUnfoldFakeDataG4RW(TTree *tree) : fChain(0) 
{
...
anaUnfoldFakeDataG4RW::~anaUnfoldFakeDataG4RW()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldFakeDataG4RW::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldFakeDataG4RW::LoadTree(Long64_t entry)
{
...
void anaUnfoldFakeDataG4RW::Init(TTree *tree)
{
...
Bool_t anaUnfoldFakeDataG4RW::Notify()
{
...
void anaUnfoldFakeDataG4RW::Show(Long64_t entry)
{
...
Int_t anaUnfoldFakeDataG4RW::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldFakeDataG4RW_cxx
