...
#ifndef anaUnfoldFakeDataFlatAngle_h
#define anaUnfoldFakeDataFlatAngle_h
...
class anaUnfoldFakeDataFlatAngle {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldFakeDataFlatAngle(TTree *tree=0);
   virtual ~anaUnfoldFakeDataFlatAngle();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(double coeff, int threshPart);
...
#ifdef anaUnfoldFakeDataFlatAngle_cxx
anaUnfoldFakeDataFlatAngle::anaUnfoldFakeDataFlatAngle(TTree *tree) : fChain(0) 
{
...
anaUnfoldFakeDataFlatAngle::~anaUnfoldFakeDataFlatAngle()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldFakeDataFlatAngle::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldFakeDataFlatAngle::LoadTree(Long64_t entry)
{
...
void anaUnfoldFakeDataFlatAngle::Init(TTree *tree)
{
...
Bool_t anaUnfoldFakeDataFlatAngle::Notify()
{
...
void anaUnfoldFakeDataFlatAngle::Show(Long64_t entry)
{
...
Int_t anaUnfoldFakeDataFlatAngle::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldFakeDataFlatAngle_cxx
