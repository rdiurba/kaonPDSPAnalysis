...
if ( numPart<=threshPart && leadingAngle>coeff && true_beam_endZ_data>30 && true_beam_endZ_data<220.0 && true_beam_endProcess_data->find("kaon+Inelastic")!=std::string::npos) weight=weightLeadingAngle->Interpolate(leadingAngle);

//if (numPart==1 && leadingAngle>0.99 && true_beam_endZ_data>30 && true_beam_endZ_data<220.0 && true_beam_endProcess->find("kaon+Inelastic")!=std::string::npos) weight=2;
//else if(numPart==1 && true_beam_endZ_data>30 && true_beam_endZ_data<220.0 && true_beam_endProcess->find("kaon+Inelastic")!=std::string::npos) weight=(1-2*histLeadingAngle->GetBinContent(20)/histLeadingAngle->GetEntries())/(1-histLeadingAngle->GetBinContent(20)/histLeadingAngle->GetEntries());
