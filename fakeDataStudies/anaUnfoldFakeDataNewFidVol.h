...
#ifndef anaUnfoldFakeDataNewFidVol_h
#define anaUnfoldFakeDataNewFidVol_h
...
class anaUnfoldFakeDataNewFidVol {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldFakeDataNewFidVol(TTree *tree=0);
   virtual ~anaUnfoldFakeDataNewFidVol();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(double vol, double vol2);
...
#ifdef anaUnfoldFakeDataNewFidVol_cxx
anaUnfoldFakeDataNewFidVol::anaUnfoldFakeDataNewFidVol(TTree *tree) : fChain(0) 
{
...
anaUnfoldFakeDataNewFidVol::~anaUnfoldFakeDataNewFidVol()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldFakeDataNewFidVol::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldFakeDataNewFidVol::LoadTree(Long64_t entry)
{
...
void anaUnfoldFakeDataNewFidVol::Init(TTree *tree)
{
...
Bool_t anaUnfoldFakeDataNewFidVol::Notify()
{
...
void anaUnfoldFakeDataNewFidVol::Show(Long64_t entry)
{
...
Int_t anaUnfoldFakeDataNewFidVol::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldFakeDataNewFidVol_cxx
