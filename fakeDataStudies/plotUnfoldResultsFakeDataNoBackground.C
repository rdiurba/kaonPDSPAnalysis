...
TFile f6(Form("kaonUnfoldDatadrivenG4RWNoFakes_%d.root",index));
...
//g414->Draw("SAME");
  ...
  lErr->AddEntry(recoXSec6,Form("Fake Data with No BG: #sigma_{G4}*%1.1f",coeff),"lp");
...
lErr->Draw("SAME");
c1.Print(Form("xSecUnfoldedFakeDataG4RWStandardGenNoFakes_%1.1f.png",coeff));
}
