...
TFile f6(Form("kaonUnfoldStandardGenFidVol_1.0_1.0.root"));
TFile f8(Form("kaonUnfoldStandardGenFidVol_-1.0_1.0.root"));
TFile f12(Form("kaonUnfoldStandardGenFidVol_1.0_-1.0.root"));
TFile f14(Form("kaonUnfoldStandardGenFidVol_-1.0_-1.0.root"));
...
recoXSec6->SetLineColor(kBlack); recoXSec->SetLineColor(kRed);
...
recoXSec12->SetMarkerColor(kBlue); recoXSec14->SetMarkerColor(kMagenta);
...
//g414->Draw("SAME");
  ...
  lErr->AddEntry(recoXSec6,Form("Fake Data (1, 1) #chi^{2}=%s",recoXSec6->GetTitle()),"l");
  lErr->AddEntry(recoXSec8,Form("Fake Data (-1, 1) #chi^{2}=%s",recoXSec8->GetTitle()),"l");
  lErr->AddEntry(recoXSec12,Form("Fake Data (1, -1) #chi^{2}=%s",recoXSec12->GetTitle()),"l");
  lErr->AddEntry(recoXSec14,Form("Fake Data (-1, -1) #chi^{2}=%s",recoXSec14->GetTitle()),"l");
...
lErr->Draw("SAME");
c1.Print(Form("xSecUnfoldedFakeDataStandardGenSCE.png"));
