...
#ifndef anaUnfoldFakeDataK0Reweight_h
#define anaUnfoldFakeDataK0Reweight_h
...
class anaUnfoldFakeDataK0Reweight {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldFakeDataK0Reweight(TTree *tree=0);
   virtual ~anaUnfoldFakeDataK0Reweight();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(double coeff, int limit);
...
#ifdef anaUnfoldFakeDataK0Reweight_cxx
anaUnfoldFakeDataK0Reweight::anaUnfoldFakeDataK0Reweight(TTree *tree) : fChain(0) 
{
...
anaUnfoldFakeDataK0Reweight::~anaUnfoldFakeDataK0Reweight()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldFakeDataK0Reweight::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldFakeDataK0Reweight::LoadTree(Long64_t entry)
{
...
void anaUnfoldFakeDataK0Reweight::Init(TTree *tree)
{
...
Bool_t anaUnfoldFakeDataK0Reweight::Notify()
{
...
void anaUnfoldFakeDataK0Reweight::Show(Long64_t entry)
{
...
Int_t anaUnfoldFakeDataK0Reweight::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldFakeDataK0Reweight_cxx
