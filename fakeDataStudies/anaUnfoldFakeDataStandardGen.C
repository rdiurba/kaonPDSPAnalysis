#define anaUnfoldTrainingStandard_cxx
#include "anaUnfoldTrainingStandard.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void anaUnfoldTrainingStandard::Loop()
{
//   In a ROOT session, you can do:
//      root> .L anaUnfoldTrainingStandard.C
//      root> anaUnfoldTrainingStandard t
...
TFile *fout = new TFile(Form("kaonUnfoldStandardGenTrainingRecoPlots.root"),"RECREATE");
...
TFile f("standard6GeVkaonTreeSel.root");
