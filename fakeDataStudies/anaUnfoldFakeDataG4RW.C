#define anaUnfoldFakeDataG4RW_cxx
#include "anaUnfoldFakeDataG4RW.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void anaUnfoldFakeDataG4RW::Loop(double coeff)
{
//   In a ROOT session, you can do:
//      root> .L anaUnfoldFakeDataG4RW.C
//      root> anaUnfoldFakeDataG4RW t
...
TFile *fout = new TFile(Form("kaonUnfoldDatadrivenG4RW_%d.root",g4rw_index+1),"RECREATE");
