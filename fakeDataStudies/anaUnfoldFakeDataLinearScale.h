...
#ifndef anaUnfoldFakeDataLinearScale_h
#define anaUnfoldFakeDataLinearScale_h
...
class anaUnfoldFakeDataLinearScale {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaUnfoldFakeDataLinearScale(TTree *tree=0);
   virtual ~anaUnfoldFakeDataLinearScale();
...
#ifdef anaUnfoldFakeDataLinearScale_cxx
anaUnfoldFakeDataLinearScale::anaUnfoldFakeDataLinearScale(TTree *tree) : fChain(0) 
{
...
anaUnfoldFakeDataLinearScale::~anaUnfoldFakeDataLinearScale()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t anaUnfoldFakeDataLinearScale::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaUnfoldFakeDataLinearScale::LoadTree(Long64_t entry)
{
...
void anaUnfoldFakeDataLinearScale::Init(TTree *tree)
{
...
Bool_t anaUnfoldFakeDataLinearScale::Notify()
{
...
void anaUnfoldFakeDataLinearScale::Show(Long64_t entry)
{
...
Int_t anaUnfoldFakeDataLinearScale::Cut(Long64_t entry)
{
...
#endif // #ifdef anaUnfoldFakeDataLinearScale_cxx
