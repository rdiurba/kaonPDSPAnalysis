#define anaUnfoldFakeDataScatterExtend_cxx
#include "anaUnfoldFakeDataScatterExtend.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void anaUnfoldFakeDataScatterExtend::Loop(double coeff)
{
//   In a ROOT session, you can do:
//      root> .L anaUnfoldFakeDataScatterExtend.C
//      root> anaUnfoldFakeDataScatterExtend t
...
TFile *fout = new TFile(Form("kaonUnfoldFakeDataScatterExtend_%1.2f.root",coeff),"RECREATE");
...
double reco_beam_calo_endZ_data;
...
t->SetBranchAddress("reco_beam_calo_endZ",&reco_beam_calo_endZ_data);
...
int numPart=0;
double extTrk_var=coeff;
double extTrk_weight=1.f;

if (true_beam_endZ_data>30 && true_beam_endZ_data<220 && reco_beam_true_byE_ID_data==true_beam_ID_data && selection_ID_data<3){
if (reco_beam_calo_endZ_data-true_beam_endZ_data>10) extTrk_weight=extTrk_var;
else extTrk_weight=(1-extTrk_var*0.16452)/(1-0.16452);

}
weight=extTrk_weight;
