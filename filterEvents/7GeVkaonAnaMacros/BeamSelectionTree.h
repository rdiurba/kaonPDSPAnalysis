...
// Tue May 31 04:10:45 2022 by ROOT version 6.22/06
// from TTree beamana/beam analysis tree
// found on file: test_kaonana_Prod4a+makeup.root
//////////////////////////////////////////////////////////

#ifndef BeamSelectionTree_h
#define BeamSelectionTree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BeamSelectionTree(TTree *tree=0);
   virtual ~BeamSelectionTree();
...
#ifdef BeamSelectionTree_cxx
BeamSelectionTree::BeamSelectionTree(TTree *tree) : fChain(0) 
{
...
chain->Add("/pnfs/dune/tape_backed/dunepro/protodune-sp/root-tuple/2022/mc/physics/PDSPProd4a/20/91/51/59/PDSPProd4a_MC_7GeV_Set00_reco1_sce_datadriven_v1_ntuple_v09_44_00_02.root/pduneana/beamana");  
chain->Add("/pnfs/dune/tape_backed/dunepro/protodune-sp/root-tuple/2022/mc/physics/PDSPProd4a/20/91/51/59/PDSPProd4a_MC_7GeV_Set01_reco1_sce_datadriven_v1_ntuple_v09_44_00_02.root/pduneana/beamana");
    tree = chain;
...
BeamSelectionTree::~BeamSelectionTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BeamSelectionTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BeamSelectionTree::LoadTree(Long64_t entry)
{
...
void BeamSelectionTree::Init(TTree *tree)
{
...
Bool_t BeamSelectionTree::Notify()
{
...
void BeamSelectionTree::Show(Long64_t entry)
{
...
Int_t BeamSelectionTree::Cut(Long64_t entry)
{
...
#endif // #ifdef BeamSelectionTree_cxx
