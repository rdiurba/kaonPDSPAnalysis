...
#ifndef BeamSelectionTreeDataOld_h
#define BeamSelectionTreeDataOld_h
...
class BeamSelectionTreeDataOld {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           beam_inst_c0;
   Int_t           beam_inst_c1;
   Double_t        beam_inst_c0press;
   Double_t        beam_inst_c1press;
   ...
   vector<vector<double> > *g4rw_full_grid_piplus_weights_fake_DataOld;
   ...
   TBranch        *b_beam_inst_c0press;   //!
   TBranch        *b_beam_inst_c1press;   //!
   ...
   TBranch        *b_g4rw_full_grid_piplus_weights_fake_DataOld;   //!
   ...
   BeamSelectionTreeDataOld(TTree *tree=0);
   virtual ~BeamSelectionTreeDataOld();
...
#ifdef BeamSelectionTreeDataOld_cxx
BeamSelectionTreeDataOld::BeamSelectionTreeDataOld(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   /*if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/dune/DataOld/users/rdiurba/kaonana_run5770_reco2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/dune/DataOld/users/rdiurba/kaonana_run5770_reco2.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/dune/DataOld/users/rdiurba/kaonana_run5770_reco2.root:/pduneana");
...
BeamSelectionTreeDataOld::~BeamSelectionTreeDataOld()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BeamSelectionTreeDataOld::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BeamSelectionTreeDataOld::LoadTree(Long64_t entry)
{
...
void BeamSelectionTreeDataOld::Init(TTree *tree)
{
   ...
   g4rw_full_grid_piplus_weights_fake_DataOld = 0;
   ...
   fChain->SetBranchAddress("beam_inst_c0press", &beam_inst_c0press, &b_beam_inst_c0press);
   fChain->SetBranchAddress("beam_inst_c1press", &beam_inst_c1press, &b_beam_inst_c1press);
   ...
   fChain->SetBranchAddress("g4rw_full_grid_piplus_weights_fake_DataOld", &g4rw_full_grid_piplus_weights_fake_DataOld, &b_g4rw_full_grid_piplus_weights_fake_DataOld);
...
Bool_t BeamSelectionTreeDataOld::Notify()
{
...
void BeamSelectionTreeDataOld::Show(Long64_t entry)
{
...
Int_t BeamSelectionTreeDataOld::Cut(Long64_t entry)
{
...
#endif // #ifdef BeamSelectionTreeDataOld_cxx
