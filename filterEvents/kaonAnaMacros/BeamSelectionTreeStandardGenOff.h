...
// found on file: /pnfs/dune/scratch/users/rdiurba/pduneana_6GeV_sce_off_ntuple_v1.root
//////////////////////////////////////////////////////////

#ifndef BeamSelectionTreeStandardGenOff_h
#define BeamSelectionTreeStandardGenOff_h
...
class BeamSelectionTreeStandardGenOff {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BeamSelectionTreeStandardGenOff(TTree *tree=0);
   virtual ~BeamSelectionTreeStandardGenOff();
...
#ifdef BeamSelectionTreeStandardGenOff_cxx
BeamSelectionTreeStandardGenOff::BeamSelectionTreeStandardGenOff(TTree *tree) : fChain(0) 
{
...
BeamSelectionTreeStandardGenOff::~BeamSelectionTreeStandardGenOff()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BeamSelectionTreeStandardGenOff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BeamSelectionTreeStandardGenOff::LoadTree(Long64_t entry)
{
...
void BeamSelectionTreeStandardGenOff::Init(TTree *tree)
{
...
Bool_t BeamSelectionTreeStandardGenOff::Notify()
{
...
void BeamSelectionTreeStandardGenOff::Show(Long64_t entry)
{
...
Int_t BeamSelectionTreeStandardGenOff::Cut(Long64_t entry)
{
...
#endif // #ifdef BeamSelectionTreeStandardGenOff_cxx
