#define BeamSelectionTreeStandardGen_cxx
#include "BeamSelectionTreeStandardGen.h"
#include <TH2.h>
#include <TF1.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void BeamSelectionTreeStandardGen::Loop(int PDG)
{
//gSystem->Load("RooUnfold/libRooUnfold");
//   In a ROOT session, you can do:
//      root> .L BeamSelectionTreeStandardGen.C
//      root> BeamSelectionTreeStandardGen t
...
TFile *fout = new TFile(Form("/dune/data/users/rdiurba/standard6GeV%sTreeSel.root",fileString.c_str()),"RECREATE");
